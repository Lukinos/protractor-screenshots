...
(function() {
  var Q, _, capabilities, capabilityString, disableScreenshots, fs, getPath, matchScreenshot, matchesCapabilities, mkdirp, resemble, rimraf, saveFailureImages, screenshotBase, screenshotCapabilityFn, screenshotDesiredPercentage, screenshotSizes, slug, takeScreenshot;
  ...
  screenshotCapabilityFn = browser.params['screenshotsCapabilityFn'] || function(browserName, platform, version) {
  ...
  browser.getCapabilities().then(function(returnValue) {
    ...
    return capabilityString = screenshotCapabilityFn(browserName, platform, version);
  });
